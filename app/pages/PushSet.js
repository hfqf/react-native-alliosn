        ...
        JPush.getRegistrationID(function (rid) {
            ...
            HTTP.startPostPromise(URLS.tidingsSwitch, body)
                .then((data) => {
                    ...
                    that.setState({tidingsSwitch: data.data.tidingsSwitch == 0?true:false});
            ...
            <View style={styles.container}>
                ...
                <TouchableWithoutFeedback  style={{ flex:1, backgroundColor: 'transparent',}}
                                           onPress={()=>{
                                               ...
                                               JPush.getRegistrationID(function (rid) {
                                                   ...
                                                   const body = {
                                                       deviceId: DeviceInfo.getUniqueID(),
                                                       tidingsSwitch: that.state.tidingsSwitch ? '1' : '0',
                                                       registrationId:rid.length==0?DeviceInfo.getUniqueID():rid
                                                   };

                                                   HTTP.startPostPromise(URLS.updateTidingsSwitch, body)
                                                       .then((data) => {

                                                           that.setState({tidingsSwitch: !that.state.tidingsSwitch});
                ...
                <View style={styles.textBgInput}>
                    ...
                    <Text style={styles.textInputStyle2}>
                        {this.state.tidingsSwitch?'已打开':'已关闭'}
                    </Text>

                    <Image resizeMode="cover" style={styles.logoStyle} source={require('../resource/mine/arrow_right.png')}/>
