...
export default class ChangeTelPhone extends Component {
  ...
  render() {
                ...
                <View style={styles.inputBg1}>
                    ...
                    <View style={styles.textBgInput}>
                        ...
                        <TextInput
                            ...
                            style={styles.textInput1}
                            onChangeText={(text) => {
                                this.setState({yzcode:text,isNeedAccountClearBtn:text.length>0})
                            }}
                        ...
                        <components.Button fontSize={15} titleColor={COLOR.theme} style= {this.state.canSendSms ? styles.codeBtnNormalStyle : styles.codeBtnStyle} disabled={this.state.canSendSms == false} title= {this.state.canSendSms ? '重发' :this.state.second+'s'} callback={() => this._sendVerifyBtnClicked()}></components.Button>
    ...
    login() {
        ...
        HTTP.startPostPromise(URLS.changeTelephone,body)
            .then((data)=>{
    ...
    _sendVerifyBtnClicked(){
        ...
        HTTP.startPostPromise(URLS.sms,{telephone:this.state.account,source:'4'})
            .then((data2)=>{
