...
#define  SERVER                       KEY_IS_DEV ?( KEY_IS_DEVICE ? @"http://192.168.3.107:18080" : @"http://localhost:18080")   :          @"http://autorepairhelper.duapp.com"
...
#define  PUSH_ID                      [JPUSHService registrationID] == nil ? @"75984375843" : [JPUSHService registrationID]
...
#define  KEY_COMMON_ORANGE_CORLOR                   UIColorFromRGB(0xFF4500)
...
#define KEY_AUTO_IS_NEED_DISPATCH_SET        @"KEY_AUTO_IS_NEED_DISPATCH_SET"
#define KEY_PUSHID_CREATER          @"KEY_PUSHID_CREATER"

#define KEY_EMPLOYEE_CAN_ADDREPAIR  @"KEY_EMPLOYEE_CAN_ADDREPAIR"
#define KEY_EMPLOYEE_CAN_ADDCONTACT  @"KEY_EMPLOYEE_CAN_ADDCONTACT"
#define KEY_EMPLOYEE_CAN_EDITCONTACT  @"KEY_EMPLOYEE_CAN_EDITCONTACT"
#define KEY_EMPLOYEE_CAN_DELCONTACT  @"KEY_EMPLOYEE_CAN_DELCONTACT"
#define KEY_EMPLOYEE_CAN_SEEREPAIRS  @"KEY_EMPLOYEE_CAN_SEEREPAIRS"
...
#define  KEY_EMPLOYEES               @"KEY_EMPLOYEES"
